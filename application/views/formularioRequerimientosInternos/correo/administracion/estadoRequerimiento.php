...
<h3 style="margin: 0px;">Estimados, se le informa que se ha <?= strtolower($cabecera['requerimientoInternoDetalleEstado']) ?> el requerimiento interno con la siguiente información:</h3>
<br>
<div class="row">
    <fieldset style="margin-bottom:15px;">
        ...
        <div style="width: 70%;display: table-cell;">
            <div>
                ...
                <label for="nombre" style="border:0px;"><?= verificarEmpty($cabecera['requerimientoInterno'], 3) ?></label>
            </div>
            <div>
