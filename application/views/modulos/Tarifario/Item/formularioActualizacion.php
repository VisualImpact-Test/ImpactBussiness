    ...
    <div class="row">
        <div class="col-md-10 child-divcenter">
            <div class="control-group child-divcenter row w-100">
                ...
                <input class="form-control col-md-7" id="nombre" name="nombre" value="<?= $informacionItem['item'] ?>">
                <input class="d-none" id="idItem" name="idItem" patron="requerido" value="<?= $informacionItem['idItem'] ?>">
                <input class="d-none" id="idItemTarifario" name="idItemTarifario" patron="requerido" value="<?= $informacionItem['idItemTarifario'] ?>">
            </div>
            <div class="control-group child-divcenter row w-100">
                ...
                <select class="form-control col-md-7" id="proveedor" name="proveedor" patron="requerido">
                    <?= htmlSelectOptionArray2(['title' => 'Seleccione', 'query' => $proveedor, 'class' => 'text-titlecase', 'selected' => $informacionItem['idProveedor']]); ?>
                </select>
            </div>
            <div class="control-group child-divcenter row w-100">
