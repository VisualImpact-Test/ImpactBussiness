...
<div class="card-datatable">
    <table id="tb-proveedor" class="mb-0 table table-bordered text-nowrap" width="100%">
        <thead>
            <tr>
            ...
            ?>
                <tr data-id="<?= $key ?>">
                    ...
                    <td class="td-center style-icons">
                        ...
                        ?>
                            <a href="javascript:;" class="btn btn-outline-secondary border-0 btn-validar" title="Validar Proveedor"><i class="fa fa-lg fa-eye"></i></a>
                        <?
                        }
                        ?>
                    </td>
