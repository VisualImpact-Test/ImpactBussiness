			...
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item btnReporte" id="tipoReporte" name="tipoReporte" url="visibilidad">
						<a data-toggle="tab" href="#idContentCotizacionEfectiva" class="active nav-link" data-value="1">Detalle</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block">
	...
	<div class="customizer-content p-2 ps-container ps-theme-dark" data-ps-id="aca1f25c-4ed9-a04b-d154-95a5d6494748">
		<form id="frm-cotizacionEfectiva">
			...
			<div class="customizer-content-filter">
				...
				<div class="form-row">
					<div class="col-md-12">
						...
						<div class="mb-2 mr-sm-2 position-relative form-group custom_tooltip">
							<span class="tooltiptext">CotizacionEfectiva</span>
							<input class="form-control form-control-sm" name="cotizacionEfectiva" id="cotizacionEfectiva">
						</div>
					</div>
				</div>
			</div>
...
<div class="main-card mb-3 card">
	<div class="card-body p-0">
		<div class="tab-content" id="content-auditoria">
			<div class="tab-pane fade show active" id="idContentCotizacionEfectiva" role="tabpanel">
