	...
	<div class="row">
		<div class="col-md-10 child-divcenter">
			<div class="control-group child-divcenter row w-100">
				...
				<input class="form-control col-md-7" id="nombre" name="nombre" patron="requerido" value="">
			</div>
			<div class="control-group child-divcenter row w-100">
				<label class="form-control col-md-5" for="nombre" style="border:0px;">Caracteristicas :</label>
				<input class="form-control col-md-7" id="caracteristicas" name="caracteristicas" patron="requerido" value="">
			</div>
			<div class="control-group child-divcenter row w-100">
