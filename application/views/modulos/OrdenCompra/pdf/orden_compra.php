<div style="text-align:justify;">
	<table border="1" style="width: 100%;">
		...
		<tr>
			...
			<td class="text-left bold" width="<?= $w4 ?>">N° DE ORDEN: <span style="margin-left: 50px"> OC<?= $data['seriado'] ?></span></td>
		</tr>
		<tr>
			<td class="text-left bold" width="<?= $w1 ?>" rowspan="2">Unidad de Negocio</td>
			<td class="text-center" width="<?= $w2 ?>" rowspan="2"><?= strtoupper(verificarEmpty($data['cuenta'], 3)) ?></td>
