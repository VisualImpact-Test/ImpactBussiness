...
<h3 style="margin: 0px;">Estimados, se le informa que se ha generado un nuevo presupuesto con la siguiente información:</h3>
<br>
<div class="row">
    <fieldset style="margin-bottom:15px;">
        ...
        <div style="width: 70%;display: table-cell;">
            <div>
                ...
                <label for="nombre" style="border:0px;"><?= verificarEmpty($cabecera['presupuesto'], 3) ?></label>
            </div>
            <div>
        ...
        <div style="width: 30%;display: table-cell;">
            <div>
                <label for="tipo" style="border:0px;">Tipo :</label>
                <label for="tipo" style="border:0px;"><?= verificarEmpty($cabecera['tipoPresupuesto'], 3) ?></label>
            </div>
            <div>
                ...
                <table class="tabla" id="listaItemsPresupuesto" style="background:#ffffff;color:#666666" width="100%" class="tabla">
                    <thead class="thead-light">
                        <tr class="row_data">
                            ...
                            <th style="width: 7%;background-color: #2586da;color: white;" class="text-center header">Costo Actual</th>
