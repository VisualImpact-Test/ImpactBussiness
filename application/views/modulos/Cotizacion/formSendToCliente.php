    ...
    <form class="ui form" role="form" id="formSendToCliente" method="post">
        ...
        <div class="fields ">
            <div class="sixteen wide field">
                ...
                <select name="flagEnviarCorreo" id="flagEnviarCorreo" class="ui fluid search clearable dropdown simpleDropdown" patron="requerido" onchange="$('.divCorreo').toggleClass('d-none'); $(this).val() == 1 ?  $(this).closest('form').find('#correos').attr('patron','requerido') : $(this).closest('form').find('#correos').removeAttr('patron') ">
        ...
        <div class="divCorreo fields d-none">
            <div class="sixteen wide field">
