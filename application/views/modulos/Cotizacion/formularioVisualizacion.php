<form class="form" role="form" id="formvisualizacionCotizacion" method="post">
	...
	<div class="row" style="margin-top: 15px;">
		<div class="col-md-11 child-divcenter">
			...
			<div class="pt-2">
				<?php if ($btnCot) :  ?>
					<button type="button" class="btn btn-trade-visual btn-descargarCotizacion" data-id="<?= verificarEmpty($cabecera['idCotizacion'], 3) ?>" style="margin-bottom: 15px;">Reporte Cotizacion
					</button>
				<?php endif; ?>
				<?php if ($btnOper) :  ?>
