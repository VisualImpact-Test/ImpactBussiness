...
<table class="tb-detalle" style="width: 100%; margin-bottom: 10px;">
	...
	<tbody>
		<?php foreach ($detalle as $key => $row) : ?>
			...
			<?php endif; ?>
			<?php if ($row['idItemTipo'] == COD_ARTICULO['id'] || $row['idItemTipo'] == COD_TEXTILES['id'] || $row['idItemTipo'] == COD_MOVIL['id'] || $row['idItemTipo'] == COD_DISTRIBUCION['id'] || $row['idItemTipo'] == COD_TARJETAS_VALES['id'] || $row['idItemTipo'] == COD_CONCURSO['id'] || $row['idItemTipo'] == COD_PAGOS_FARMACIAS['id'] || $row['idItemTipo'] == COD_SERVICIO_GENERAL['id'] || $row['idItemTipo'] == COD_RUTAS_VIAJERAS['id']) : ?>
				<tr class="bg-gray">
					<td class="text-center"><?= $key + 1 ?></td>
				...
				<?php endif; ?>
			<?php endif; ?>
			<?php if ($row['idItemTipo'] == COD_CONCURSO['id'] || $row['idItemTipo'] == COD_TARJETAS_VALES['id'] || $row['idItemTipo'] == COD_PAGOS_FARMACIAS['id'] || $row['idItemTipo'] == COD_SERVICIO_GENERAL['id'] || $row['idItemTipo'] == COD_RUTAS_VIAJERAS['id']) : ?>
