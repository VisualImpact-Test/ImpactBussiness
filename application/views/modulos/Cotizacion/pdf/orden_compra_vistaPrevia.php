<div style="text-align:justify">
	...
	<table border="1" style="width: 100%;">
		...
		<tr>
			...
			<td class="text-left bold" width="<?= $w4 ?>">N° DE ORDEN: OCXXXXXX</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="text-left" width="<?= $w4 ?>"><?= verificarEmpty(date_change_format($data['fechaEntrega']), 3) ?></td>
		</tr>
	</table>
</div>
