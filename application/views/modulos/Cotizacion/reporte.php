						...
						<?php if ($row['estado'] == 1) : ?>
							...
							<div class="<?= (!$row['cotizacionValidaCliente']) ? 'disabled' : '' ?>">
								...
								<?php if ($row['idCotizacionEstado'] == ESTADO_COTIZACION_APROBADA) : ?>
									...
									<a href="javascript:;" class="btn btn-outline-secondary border-0 btnRutasViajeras" data-id="<?= $row['idCotizacion']; ?>"><i class="route icon" style="visibility: visible;" title="Rutas Viajeras"></i></a>
