										...
										foreach ($cotizacionDetalleSub[$row['idCotizacionDetalle']][COD_TEXTILES['id']] as $dataSubItem) : ?>
											<div class="fields body-sub-item ">
												...
												<div class="three wide field">
													...
													<select class="ui generoSubItem" name="generoSubItem[<?= $cont ?>]">
														<?= htmlSelectOptionArray2(['title' => 'Sin seleccionar', 'selected' => verificarEmpty($dataSubItem['genero']), 'query' => LIST_GENERO,  'class' => 'text-titlecase ', 'simple' => true]); ?>
													</select>
												</div>
												<div class="two wide field">
										...
										foreach ($cotizacionDetalleSub[$row['idCotizacionDetalle']][COD_SERVICIO['id']] as $dataSubItem) : ?>
											<div class="fields body-sub-item body-sub-item-servicio">
												<div class="eleven wide field">
													...
													<input class="nombreSubItem" name="nombreSubItemServicio[<?= $cont ?>]" placeholder="Nombre" value="<?= !empty($dataSubItem['nombre']) ? $dataSubItem['nombre'] : '' ?>">
												</div>
												<div class="five wide field">
													<div class="ui sub header">Cantidad</div>
													<input class="onlyNumbers cantidadSubItem" name="cantidadSubItemServicio[<?= $cont ?>]" placeholder="0" value="<?= !empty($dataSubItem['cantidad']) ? $dataSubItem['cantidad'] : '' ?>">
												</div>
												<div class="one wide field">
													<div class="ui sub header">Eliminar</div>
													<button type="button" class="ui basic button btn-eliminar-sub-item">
								...
								if (!empty($cotizacionDetalleSub[$row['idCotizacionDetalle']][COD_DISTRIBUCION['id']])) :
									foreach ($cotizacionDetalleSub[$row['idCotizacionDetalle']][COD_DISTRIBUCION['id']] as $dataSubItem) : ?>
										<div class="seven wide field">
											...
											<select class="ui dropdown simpleDropdown tipoServicioForm tipoServicioSubItem" name="tipoServicioSubItem[<?= $cont ?>]">
										...
										<div class="three wide field">
											...
											<input type="hidden" class="unidadMedidaSubItem" name="unidadMedidaSubItem[<?= $cont ?>]" placeholder="Unidad Medida" value="<?= !empty($dataSubItem['idUnidadMedida']) ? $dataSubItem['idUnidadMedida'] : '' ?>" readonly>
										</div>
										<div class="three wide field">
											<div class="ui sub header">Costo S/</div>
											<input class="costoTipoServicio costoSubItem" name="costoSubItem[<?= $cont ?>]" placeholder="Costo" value="<?= !empty($dataSubItem['costo']) ? $dataSubItem['costo'] : '' ?>" readonly>
										</div>
										<div class="three wide field">
											<div class="ui sub header">Cantidad</div>
											<input class="onlyNumbers cantidadSubItemDistribucion cantidadSubItem" name="cantidadSubItemDistribucion[<?= $cont ?>]" placeholder="Cantidad" value="<?= !empty($dataSubItem['cantidad']) ? $dataSubItem['cantidad'] : '' ?>">
										</div>
										<div class="tbDistribucionTachado d-none">
											<h4 class="ui dividing header">TACHADO</h4>
											<input value='0' class='chkTachadoDistribucion d-none' type="radio" name="chkTachado[<?= $cont ?>]" checked>
						...
						<div class="ui form attached fluid segment my-3 d-none div-features div-feature-<?= COD_TEXTILES['id'] ?>">
							...
							<div class="content-body-sub-item">
								<div class="fields body-sub-item ">
									...
									<div class="three wide field">
										<div class="ui sub header">Genero</div>
										<select class="ui generoSubItem" name="generoSubItem[0]">
											<?= htmlSelectOptionArray2(['query' => LIST_GENERO, 'class' => 'text-titlecase', 'simple' => true, 'title' => 'Sin seleccionar']); ?>
										</select>
									</div>
									<div class="three wide field">
										<div class="ui sub header">Cantidad</div>
