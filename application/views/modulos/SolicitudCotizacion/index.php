			...
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item btnReporte" id="tipoReporte" name="tipoReporte" url="visibilidad">
						<a data-toggle="tab" href="#idContentCotizacion" class="active nav-link" data-value="1">Detalle</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="customizer-content p-2 ps-container ps-theme-dark" data-ps-id="aca1f25c-4ed9-a04b-d154-95a5d6494748">
		<form id="frm-cotizacion">
			...
			<div class="customizer-content-button center-items">
				...
				<button type="button" class="btn btn-outline-trade-visual border-0" data-url="" id="filtrarCotPro" title="Cotización Prov.">
					<strong>COT P.</strong><span class="txt_filtro"></span>
				</button>
...
<div class="main-card mb-3 card">
	<div class="card-body p-0">
		<div class="tab-content" id="content-auditoria">
			<div class="tab-pane fade show active" id="idContentCotizacion" role="tabpanel">
