    ...
    <div class="customizer-content p-2 ps-container ps-theme-dark" data-ps-id="aca1f25c-4ed9-a04b-d154-95a5d6494748">
        <form id="frm-servicioProveedor">
            ...
            <div class="customizer-content-button center-items">
                <button type="button" class="btn btn-outline-trade-visual border-0" data-url="reporte" id="btn-filtrarServicioProveedor" title="Consultar">
                    <i class="fa fa-search"></i>
                </button>
                <button type="button" class="btn btn-outline-trade-visual border-0" id="btn-proveedor" title="Proveedor">
                    <i class="fa fa-user"></i>
                </button>
                <!-- <button type="button" class="btn btn-outline-trade-visual border-0" onclick="exportToExcel('tb-servicioProveedor', 'ExcelSheet.xlsx')" title="Excell">
...
<div class="main-card mb-3 card">
    <div class="card-body p-0">
        <div class="tab-content" id="content-auditoria">
            <div class="tab-pane fade show active" id="idServicioProveedor" role="tabpanel">
