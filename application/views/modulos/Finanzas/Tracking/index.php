			...
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item btnReporte" id="tipoReporte" name="tipoReporte" url="visibilidad">
						<a data-toggle="tab" href="#idContentTracking" class="active nav-link" data-value="1">Detalle</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="customizer-content p-2 ps-container ps-theme-dark" data-ps-id="aca1f25c-4ed9-a04b-d154-95a5d6494748">
		<form id="frm-tracking">
			...
			<div class="customizer-content-button center-items">
				<button type="button" class="btn btn-outline-trade-visual border-0" data-url="reporte" id="btn-filtrarTracking" title="Consultar">
					<i class="fa fa-search"></i> <span class="txt_filtro"></span>
				</button>
				<button type="button" class="btn btn-outline-trade-visual border-0" data-url="descargar" id="btn-descargarTracking" title="Descarga">
					<i class="icon file excel outline"></i> <span class="txt_filtro"></span>
				</button>
			</div>
			<hr>
				...
				<div class="form-row">
					<div class="col-md-12">
						...
						<div class="mb-2 mr-sm-2 position-relative form-group custom_tooltip">
							...
							<select class="form-control form-control-sm ui my_select2Full" name="estadoTracking" id="estadoTracking">
...
<div class="main-card mb-3 card">
	<div class="card-body p-0">
		<div class="tab-content" id="content-auditoria">
			<div class="tab-pane fade show active" id="idContentTracking" role="tabpanel">
