		...
		<div class="card w-100 mb-3 p-0">
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item btnReporte" name="UsuarioReporte" url="visibilidad">
						<a data-toggle="tab" href="#idContentUsuarioDetalle" class="active nav-link" data-value="1" data-tipo="Detalle">Detalle</a>
					</li>
	...
	<div class="customizer-content p-2 ps-container ps-theme-dark" data-ps-id="aca1f25c-4ed9-a04b-d154-95a5d6494748">
		<form id="frm-usuario">
			...
			<div class="customizer-content-button center-items">
				<button type="button" class="btn btn-outline-trade-visual border-0" data-url="reporte" id="btn-filtrarUsuario" title="Consultar">
					<i class="fa fa-search"></i> <span class="txt_filtro"></span>
				</button>
				<!-- <button type="button" class="btn btn-outline-trade-visual border-0" data-url="registrar" id="btn-registrarTipo" title="Nuevo">
...
<div class="main-card mb-3 card">
	<div class="card-body p-0">
		<div class="tab-content" id="content-auditoria">
			<div class="tab-pane fade show active" id="idContentUsuarioDetalle" role="tabpanel">
