                        ...
                        <td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                <tr>
                                    <td>
                                        <!-- Section 1 -->
                                        <div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="https://www.thekickassentrepreneur.com/wp-content/uploads/2019/03/Business-Failed.jpg" border="0" width="650" height="280" alt="" /></a></div>
                                        <!-- END Section 1 -->
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="direction:ltr !important;">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <!-- Article Image -->
                                                                            <div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;margin-top:30px;"><a href="#" target="_blank"><img src="https://chinaimportar.com/wp-content/uploads/2021/10/como-importar-china-1.jpg" border="0" width="360px" height="150px" alt="" /></a></div>
                                                                            <!-- END Article Image -->
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                                                <tr>
                                                                                    <td height="10" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
